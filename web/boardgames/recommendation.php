            ...
            <section class="wide-section">
                ...
                <?php
                    ...
                    if ($best_game==0) {
                        ...
                        echo '<p>The Board Game Whisperer thinks you have a ' . $best_game_score . '% chance of enjoying the game <h3>' . $board_game_safe . '.</h3></p><br><div class="center-game"><img src="' . $game_image_safe . '" alt="' . $board_game_safe . '"></div>';
